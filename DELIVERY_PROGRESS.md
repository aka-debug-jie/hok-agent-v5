...
|---|---|---|
| Hierarchical Policy v0 | `E1D_TEMPORAL_PROBE_PASSED_NON_PROMOTING`: overfit32 passed; dev temporal F1 1.0 vs last/shuffle 0.8571 | Freeze for offline replay only; Reward and online learning remain closed |
...
```text
CURRENT GOAL: E1d frozen offline replay
BLOCKING FAILURE: dev support is only 7 sessions and semantic accuracy is unverified
NEXT ACCEPTANCE COMMAND: make hierarchical-e1d-probe-smoke, then a frozen replay contract
