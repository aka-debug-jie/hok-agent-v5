...
NEW_BYTES: 1,491,450,755 used by the active-probe and goal-navigation lineages to date; the 268,435,456 question cap is exceeded and the owner has stated there is no budget limit (this total adds the 222,454,107 of the five route B v15 device runs, the 4,248 of the probe re-analysis output, the 29,551,263 of the two probe sessions and their analysis, the 170,099 of the placement and pre-flight images, the 1,828,915 of the preserved death reference, the 85,962,294 of the two probe calibration runs and their analyses, the 2,270,045 of the two repositions and the cold-start batch, the 88,363,295 of the v16 and v17 cold-start attempts and their repositions, and the route B review's 4,177,652 completed form to the previous 1,060,808,197)
