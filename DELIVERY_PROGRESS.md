...
|---|---|---|
| Hierarchical Policy v0 | `E1D_CLIP_MATERIALIZATION_PASSED_NON_PROMOTING`: 33/7 event-centered pairs, ordinal accuracy 0.424/0.429 | Run temporal vs last-frame/shuffle probe; Reward and online learning remain closed |
...
```text
CURRENT GOAL: E1d temporal-vs-last-frame/shuffle learnability probe
BLOCKING FAILURE: event-centered clips have no visual learnability evidence yet
NEXT ACCEPTANCE COMMAND: make hierarchical-e1d-clip-smoke, then a frozen model probe
