...
NEW_BYTES: 909,422,347 used by the active-probe and goal-navigation lineages to date; the 268,435,456 question cap is exceeded and the owner has stated there is no budget limit (this total adds 24,298,168 for the single-arbiter planner batch to the previous 885,124,179)
