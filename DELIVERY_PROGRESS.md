...
NEW_BYTES: 1,314,806,741 used by the active-probe and goal-navigation lineages to date; the 268,435,456 question cap is exceeded and the owner has stated there is no budget limit (this total adds the 222,454,107 of the five route B v15 device runs, the 4,248 of the probe re-analysis output, the 29,551,263 of the two probe sessions and their analysis, the 170,099 of the placement and pre-flight images, the 1,780,535 of the preserved death reference, and the route B review's 4,177,652 completed form to the previous 1,060,808,197)
